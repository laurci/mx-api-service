...
export class GatewayService {
  ...
  async getNetworkStatus(
    metaChainShardId: number | string,
  ): Promise<NetworkStatus> {
    const result = await this.get(
      `network/status/${metaChainShardId}`,
      GatewayComponentRequest.networkStatus,
    );
  ...
  async getNetworkConfig(): Promise<NetworkConfig> {
    const result = await this.get(
      'network/config',
      GatewayComponentRequest.networkConfig,
    );
  ...
  async getNetworkEconomics(): Promise<NetworkEconomics> {
    const result = await this.get(
      'network/economics',
      GatewayComponentRequest.networkEconomics,
    );
  ...
  async getNodeHeartbeatStatus(): Promise<HeartbeatStatus[]> {
    const result = await this.get(
      ...
      GatewayComponentRequest.nodeHeartbeat,
    );
  ...
  async getTrieStatistics(shardId: number): Promise<TrieStatistics> {
    const result = await this.get(
      `network/trie-statistics/${shardId}`,
      GatewayComponentRequest.trieStatistics,
    );
  ...
  async getEsdtSupply(identifier: string): Promise<EsdtSupply> {
    const result = await this.get(
      `network/esdt/supply/${identifier}`,
      GatewayComponentRequest.esdtSupply,
    );
    return result;
  }
  ...
  async getEsdtFungibleTokens(): Promise<string[]> {
    const result = await this.get(
      ...
      GatewayComponentRequest.allFungibleTokens,
    );
  ...
  async getAddressEsdtRoles(address: string): Promise<EsdtAddressRoles> {
    const result = await this.get(
      ...
      GatewayComponentRequest.addressEsdtAllRoles,
    );
    return result;
  }
  ...
  async getAddressEsdt(
    ...
    const result = await this.get(
      `address/${address}/esdt/${identifier}`,
  ...
  async getAddressNft(address: string, identifier: string): Promise<NftData> {
    ...
    // eslint-disable-next-line require-await
    const result = await this.get(
      `address/${address}/nft/${esdtIdentifier}/nonce/${nonceNumeric}`,
  ...
  async getTransaction(txHash: string): Promise<Transaction | undefined> {
    ...
    const result = await this.get(
      ...
      GatewayComponentRequest.transactionDetails,
      async (error) => {
  ...
  private getUrl(component: GatewayComponentRequest): string {
    ...
    if (lightGatewayComponents.includes(component)) {
      return (
        this.apiConfigService.getLightGatewayUrl() ??
